...
# Likewise, all people on the previous publication, or people that have since 
...
form a modular toolkit whose components can be used in anything from quick scripts, e.g. to convert some data 
to the right format for some other program, to larger applications, such as the SUPERSMART pipeline [Antonelli10092016] 
or the Monophylizer [Mutanen01112016] web service.
